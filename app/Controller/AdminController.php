    ...
    class AdminController{
        ...
        public function insert(){
            try{
                ...
                echo '<script>location.href="http://localhost/CRUD/?pagina=admin&metodo=index";</script>';
            } catch(Exception $e){
        ...
        public function update(){
            try{
                ...
                echo '<script>alert("'.$e->getMessage().'");</script>';
                echo '<script>location.href="http://localhost/CRUD/?pagina=admin&metodo=change&id='.$_POST['id'].'";</script>';
            }
